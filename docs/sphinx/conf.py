"""Sphinx configuration for scitex-db documentation."""
...
try:
    ...
    release = _get_version("scitex-db")
except Exception:
    release = "0.0.0"
...
autodoc_mock_imports = ['numpy', 'pandas', 'scitex_core', 'sqlalchemy', 'psycopg2']

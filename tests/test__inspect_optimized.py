"""Auto-generated smoke test for scitex_db._inspect_optimized.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex_db._inspect_optimized')
    except ImportError as e:
        pytest.skip(f"scitex_db._inspect_optimized: {e}")

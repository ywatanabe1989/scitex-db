...
"""Tests for scitex_db._PostgreSQLMixins._TransactionMixin module."""
...
from scitex_db._postgresql._PostgreSQLMixins import _TransactionMixin
...
class TestTransactionMixin:
    ...
    def test_inheritance_from_base_mixin(self):
        ...
        from scitex_db._BaseMixins import _BaseTransactionMixin

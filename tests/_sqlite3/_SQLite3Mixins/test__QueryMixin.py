"""Auto-generated smoke test for scitex_db._sqlite3._SQLite3Mixins._QueryMixin.
...
def test_module_imports():
    ...
    try:
        importlib.import_module('scitex_db._sqlite3._SQLite3Mixins._QueryMixin')
    except ImportError as e:
        pytest.skip(f"scitex_db._sqlite3._SQLite3Mixins._QueryMixin: {e}")
